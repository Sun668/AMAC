...
Table~\ref{tab:runs} identifies the immutable experiment outputs used by the manuscript. In the tagged tree, each run identifier resolves under an \texttt{experiments/exp\_2026\_09\_03\_*/results/} directory.
