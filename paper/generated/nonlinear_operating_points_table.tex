\begin{table*}[t]
\centering
\caption{Nonlinear-backbone operating points on the official test. $C$, $E$, and $R$ are percentages; $T_f$ is in stages. Intervals use 10,000 source-ID-prefix cluster resamples for B4$-$H0; coverage uses $|\Delta C|$. B4 uses $(\tau,\delta)=(0.20,0)$.}
